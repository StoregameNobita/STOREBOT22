...
const config = {
    A187: '🔰_STOREBOT_🔰',
    instagram: 'https://instagram.com/STOREBOT',
    nomer: 'wa.me/6282334323905',
    aktif: 'AKTIF KECUALI HARI KIAMAT',
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] QR code by AMIR & STOREBOT, Scan kode qr mu om!`)
})
